...
kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic first_topic --group my-first-application --formatter kafka.tools.DefaultMessageFormatter --property print.partition=true --property print.timestamp=true --property print.key=true --property print.value=true --from-beginning
